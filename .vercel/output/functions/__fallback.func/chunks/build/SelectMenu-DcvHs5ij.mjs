import { _ as _export_sfc, f as __nuxt_component_3, E as __nuxt_component_2$1, m as mergeConfig, g as useUI, q as useInjectButtonGroup, R as computedAsync, t as twMerge, h as appConfig, p as useDebounceFn, w as get, S as select, T as selectMenu } from './server.mjs';
...
import { s, i as i$1, u, o as o$1, A as A$1, E, T, N, a as o$3 } from './keyboard-Duq8EHr3.mjs';
import { w, n } from './use-outside-click-BHqYmLlt.mjs';
import { s as s$1 } from './use-resolve-button-type-DOOP2SMg.mjs';
import { p, u as u$1, i as i$4, f as f$2, c } from './use-text-value-CKO20D-4.mjs';
import { f as f$1, u as u$2 } from './hidden-Dc_fFmis.mjs';
import { l, i as i$2, t as t$1 } from './open-closed-CJlEqXqx.mjs';
import { w as w$1, h, i as i$3, O } from './focus-management-vHH7q6nP.mjs';
import { n as defu, y as isEqual } from '../_/nitro.mjs';
import { twJoin } from 'tailwind-merge';
import { u as usePopper } from './usePopper-BrvKSG9Z.mjs';
import { u as useFormGroup } from './useFormGroup-B6xiYqr7.mjs';
...
let ie = Symbol("VirtualContext"), Ae$1 = defineComponent({ name: "VirtualProvider", setup(a, { slots: h$12 }) {
  ...
  }, defaultValue: computed(() => a.defaultValue), nullable: $2, immediate: computed(() => false), virtual: computed(() => null), inputRef: e$1, labelRef: u2, buttonRef: c$1, optionsRef: f2, disabled: computed(() => a.disabled), options: v, change(t2) {
    p2(t2);
  ...
  w([e$1, c$1, f2], () => l2.closeCombobox(), computed(() => o2.value === 0)), provide(ne, l2), t$1(computed(() => u(o2.value, { [0]: i$2.Open, [1]: i$2.Closed })));
  let g2 = computed(() => {
    var t2;
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r, emit: w$2 }) {
  ...
  let D = computed(() => o2.multiple ? 1 : 0), [y, L] = d(computed(() => o2.modelValue), (t2) => w$2("update:modelValue", t2), computed(() => o2.defaultValue)), M = computed(() => y.value === void 0 ? u(D.value, { [1]: [], [0]: void 0 }) : y.value), k = { listboxState: n2, value: M, mode: D, compare(t2, i2) {
    ...
    let d2 = u2(), O2 = f$2(t2 === c.Specific ? { focus: c.Specific, id: i2 } : { focus: t2 }, { resolveItems: () => d2.options, resolveActiveIndex: () => d2.activeOptionIndex, resolveId: (h2) => h2.id, resolveDisabled: (h2) => h2.dataRef.disabled });
  ...
  w([f2, v], (t2, i2) => {
    var l2;
    k.closeListbox(), w$1(i2, h.Loose) || (t2.preventDefault(), (l2 = o$1(f2)) == null || l2.focus());
  }, computed(() => n2.value === 0)), provide($, k), t$1(computed(() => u(n2.value, { [0]: i$2.Open, [1]: i$2.Closed })));
  let C = computed(() => {
    var t2;
  ...
  return onMounted(() => {
    ...
    return h$1(Fragment, [...t2 != null && M.value != null ? e({ [t2]: M.value }).map(([I, Q]) => h$1(f$1, E({ features: u$2.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q }))) : [], A$1({ ourProps: {}, theirProps: { ...r, ...T(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h$12, slots: b, attrs: r, name: "Listbox" })]);
  };
} });
...
//# sourceMappingURL=SelectMenu-DcvHs5ij.mjs.map
