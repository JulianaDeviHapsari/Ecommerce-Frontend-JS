...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h3 class="text-xl font-medium">Ubah No. Handphone</h3><hr class="mt-5 mb-11 border-gray-200/60"><form>`);
      _push(ssrRenderComponent(_component_UFormGroup, {
        ...
        error: !!((_b = (_a = unref(v$).phone.$errors) == null ? void 0 : _a[0]) == null ? void 0 : _b.$message)
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (unref(v$).$invalid) {
              _push2(`<p class="text-sm text-red-500 mt-1"${_scopeId}>${ssrInterpolate((_b2 = (_a2 = unref(v$).phone.$errors) == null ? void 0 : _a2[0]) == null ? void 0 : _b2.$message)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              ...
              }, toDisplayString((_d = (_c = unref(v$).phone.$errors) == null ? void 0 : _c[0]) == null ? void 0 : _d.$message), 1)) : createCommentVNode("", true),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/my-account/profile/change-phone.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=change-phone-CKjNEI8p.mjs.map
