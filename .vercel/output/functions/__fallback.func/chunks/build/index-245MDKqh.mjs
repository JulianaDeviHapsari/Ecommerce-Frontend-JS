import { _ as _export_sfc, f as __nuxt_component_3, a as __nuxt_component_0$5, b as __nuxt_component_5, m as mergeConfig, g as useUI, G as omit, h as appConfig, H as button } from './server.mjs';
import { unref, withCtx, createVNode, createBlock, createCommentVNode, openBlock, toDisplayString, Fragment, renderList, defineComponent, resolveComponent, mergeProps, renderSlot, createTextVNode, withKeys, Transition, withDirectives, vShow, toRef, computed, ref, watch, useId, onMounted, onUnmounted, provide, watchEffect, inject, useSSRContext } from 'vue';
...
import { l, i, t } from './open-closed-CJlEqXqx.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderStyle } from 'vue/server-renderer';
import { c as createReusableTemplate } from './index-v5u2CgtM.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LayoutsSidebarItem = __nuxt_component_0;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(DefineItem), null, {
        default: withCtx(({ icon, label }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="sidebar-item" data-v-d8ec89de${_scopeId}>`);
            if (icon) {
            ...
            _push2(`<p class="sidebar-item-label" data-v-d8ec89de${_scopeId}>${ssrInterpolate(label)}</p></div>`);
          } else {
            return [
              createVNode("div", { class: "sidebar-item" }, [
                icon ? (openBlock(), createBlock(_component_UIcon, {
                  key: 0,
                  name: icon,
                  class: "sidebar-item-icon"
                }, null, 8, ["name"])) : createCommentVNode("", true),
                createVNode("p", { class: "sidebar-item-label" }, toDisplayString(label), 1)
              ])
            ];
          }
        }),
      ...
      if (!__props.item.children) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: __props.item.to,
          "active-class": __props.item.exact ? "router-link-active is-exact" : "router-link-active"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(ReuseItem), __props.item, null, _parent2, _scopeId));
            } else {
              return [
                createVNode(unref(ReuseItem), __props.item, null, 16)
              ];
            }
          }),
          _: 1
        ...
        _push(ssrRenderComponent(_component_UAccordion, {
          items: [
            {
              defaultOpen: _ctx.$route.path.includes((_b = (_a = __props.item.children) == null ? void 0 : _a[0]) == null ? void 0 : _b.to),
              ...__props.item
            }
          ],
          ui: {
          ...
          default: withCtx(({ open, item: parent }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex gap-2 items-center hover:text-primary" role="button" data-v-d8ec89de${_scopeId}>`);
              _push2(ssrRenderComponent(unref(ReuseItem), {
                icon: parent.icon,
                label: parent.label,
                class: "flex-1"
              }, null, _parent2, _scopeId));
          ...
          item: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="pl-8 flex flex-col gap-4 mt-4" data-v-d8ec89de${_scopeId}><!--[-->`);
              ssrRenderList(__props.item.children, (child, index) => {
                _push2(ssrRenderComponent(_component_LayoutsSidebarItem, {
              ...
              return [
                createVNode("div", { class: "pl-8 flex flex-col gap-4 mt-4" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.item.children, (child, index) => {
                    return openBlock(), createBlock(_component_LayoutsSidebarItem, {
                      key: `child-${child.label}-${index}`,
                      item: child
                    }, null, 8, ["item"]);
                  }), 128))
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layouts/sidebar/Item.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d8ec89de"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LayoutsSidebarItem = __nuxt_component_0;
      _push(`<nav${ssrRenderAttrs(_attrs)}><ul class="flex gap-6 flex-col"><!--[-->`);
      ssrRenderList(__props.items, (item, index) => {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_LayoutsSidebarItem, { item }, null, _parent));
        _push(`</li>`);
      });
      _push(`<!--]--></ul></nav>`);
    };
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layouts/sidebar/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=index-245MDKqh.mjs.map
